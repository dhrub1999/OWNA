    ...
    <>
      ...
      <header className="flex h-20 items-center justify-between px-6 sm:px-12 border-b border-border/40">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button className="rounded-full px-6" render={<Link href="/signup" />}>
            Create your OWNA
          </Button>
        </div>
      </header>
      ...
      <main className="flex-1">
            ...
            <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
              <div className="lg:col-span-6 z-10 relative">
                <h1 className="font-display text-[56px] sm:text-[72px] lg:text-[88px] font-bold leading-[1.05] tracking-tight">
                  Your online presence<br />should feel like you.
                </h1>
                <p className="mt-8 text-xl sm:text-2xl text-muted-foreground max-w-lg leading-relaxed">
                  Create a professional digital presence without building a website from scratch.
                </p>
                <div className="mt-12 flex flex-wrap gap-4">
                  <Button size="lg" className="h-14 rounded-full px-8 text-lg font-medium" render={<Link href="/signup" />}>
                    Create your OWNA
                  </Button>
                  <Button size="lg" variant="outline" className="h-14 rounded-full px-8 text-lg font-medium border-border" render={<Link href="#explore" />}>
                    Explore OWNA
                  </Button>
                </div>
              </div>
              ...
              <div className="lg:col-span-6 relative h-[600px] w-full hidden sm:block">
                <div className="absolute top-0 right-0 w-[80%] rounded-[24px] overflow-hidden border border-border shadow-2xl rotate-3 hover:rotate-0 transition-transform duration-700 ease-out z-10 bg-background">
                  <div className="pointer-events-none h-[480px] overflow-hidden">
                    <ProfileRenderer snapshot={demoProfiles.consultant} isPreview />
                  </div>
                </div>
                <div className="absolute bottom-10 left-0 w-[70%] rounded-[24px] overflow-hidden border border-border shadow-xl -rotate-6 hover:-rotate-2 transition-transform duration-700 ease-out z-20 bg-background">
                  <div className="pointer-events-none h-[400px] overflow-hidden">
                    <ProfileRenderer snapshot={demoProfiles.jewellery} isPreview />
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-24 sm:py-32 bg-secondary/50" id="product">
          <div className="mx-auto max-w-7xl px-6 sm:px-12">
            <div className="text-center max-w-3xl mx-auto mb-20">
              <h2 className="font-display text-4xl sm:text-5xl font-bold tracking-tight">You are more than a list of links.</h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 lg:gap-16 items-stretch max-w-5xl mx-auto">
              <div className="p-10 rounded-[32px] bg-background border border-border flex flex-col">
                <h3 className="font-display text-2xl font-bold mb-8">Basic link page</h3>
                <ul className="space-y-4 text-muted-foreground text-lg flex-1">
                  <li className="flex items-center gap-4"><div className="w-1.5 h-1.5 rounded-full bg-muted-foreground/50"/> photo</li>
                  <li className="flex items-center gap-4"><div className="w-1.5 h-1.5 rounded-full bg-muted-foreground/50"/> bio</li>
                  <li className="flex items-center gap-4"><div className="w-1.5 h-1.5 rounded-full bg-muted-foreground/50"/> links</li>
                  <li className="flex items-center gap-4"><div className="w-1.5 h-1.5 rounded-full bg-muted-foreground/50"/> social icons</li>
                </ul>
              </div>
              ...
              <div className="p-10 rounded-[32px] bg-foreground text-background flex flex-col relative overflow-hidden">
                ...
                <h3 className="font-display text-2xl font-bold mb-8 relative z-10 text-background">OWNA</h3>
                <ul className="grid grid-cols-2 gap-x-4 gap-y-5 text-background font-medium text-lg relative z-10">
                  <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-primary"/> identity</li>
                  <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-primary"/> introduction</li>
                  <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-primary"/> services</li>
                  <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-primary"/> portfolio</li>
                  <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-primary"/> projects</li>
                  <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-primary"/> testimonials</li>
                  <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-primary"/> gallery</li>
                  <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-primary"/> contact</li>
                  <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-primary"/> booking</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-6 sm:px-12">
            <div className="grid lg:grid-cols-3 gap-16 lg:gap-12">
              <div className="group">
                ...
                <p className="text-muted-foreground text-lg mb-8">Choose what belongs on your page.</p>
                <div className="p-6 rounded-2xl bg-secondary/50 border border-border/50 text-sm font-medium space-y-3">
                  <div className="p-3 bg-background rounded-lg shadow-sm border border-border">Hero</div>
                  <div className="p-3 bg-background rounded-lg shadow-sm border border-border">Projects</div>
                  <div className="p-3 bg-background rounded-lg shadow-sm border border-border opacity-50 border-dashed">Add Block...</div>
                </div>
              </div>
              ...
              <div className="group">
                ...
                <p className="text-muted-foreground text-lg mb-8">Make it look like you.</p>
                <div className="p-6 rounded-2xl bg-secondary/50 border border-border/50 text-sm font-medium grid grid-cols-2 gap-3">
                  <div className="h-10 bg-background rounded-lg shadow-sm border border-border flex items-center px-3">Colors</div>
                  <div className="h-10 bg-background rounded-lg shadow-sm border border-border flex items-center px-3">Type</div>
                  <div className="h-10 bg-background rounded-lg shadow-sm border border-border flex items-center px-3 col-span-2">Layout</div>
                </div>
              </div>
              ...
              <div className="group">
                ...
                <p className="text-muted-foreground text-lg mb-8">Go live when you're ready.</p>
                <div className="p-6 rounded-2xl bg-secondary/50 border border-border/50 text-sm font-medium flex flex-col justify-center items-center h-[188px]">
                  ...
                  <div className="text-muted-foreground font-mono text-xs">owna.app/yourname</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-6 sm:px-12">
            <div className="max-w-4xl mb-24">
              ...
              <p className="text-xl sm:text-2xl text-background/70 max-w-2xl leading-relaxed">
                Your work isn't generic. Your business isn't generic. Your story isn't generic. Your online presence shouldn't be either.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
              <div className="rounded-[24px] overflow-hidden h-[500px] border border-white/10 bg-background">
                <div className="pointer-events-none h-full overflow-hidden">
                  <ProfileRenderer snapshot={demoProfiles.photographer} isPreview />
                </div>
              </div>
              <div className="rounded-[24px] overflow-hidden h-[500px] border border-white/10 bg-background md:translate-y-16">
                <div className="pointer-events-none h-full overflow-hidden">
                  <ProfileRenderer snapshot={demoProfiles.freelancer} isPreview />
                </div>
              </div>
        ...
        <section className="py-32 sm:py-40">
          <div className="mx-auto max-w-7xl px-6 sm:px-12">
            <div className="mb-20">
              <h2 className="font-display text-4xl sm:text-5xl font-bold tracking-tight">Made for people with something to say.</h2>
            </div>

            <div className="grid md:grid-cols-2 gap-y-16 gap-x-12 lg:gap-x-24">
              <div>
                <h3 className="text-2xl font-bold mb-2">Independent professionals</h3>
                <p className="text-muted-foreground text-lg mb-8">Your expertise deserves a home.</p>
                <div className="rounded-2xl border border-border p-8 bg-secondary/30">
                   <div className="font-medium mb-4">Common blocks:</div>
                   <div className="flex flex-wrap gap-2">
                     <span className="px-4 py-1.5 rounded-full border border-border bg-background text-sm">About</span>
                     <span className="px-4 py-1.5 rounded-full border border-border bg-background text-sm">Services</span>
                     <span className="px-4 py-1.5 rounded-full border border-border bg-background text-sm">Testimonials</span>
                   </div>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-lg mb-8">Bring your brand beyond social media.</p>
                <div className="rounded-2xl border border-border p-8 bg-secondary/30">
                   <div className="font-medium mb-4">Common blocks:</div>
                   <div className="flex flex-wrap gap-2">
                     <span className="px-4 py-1.5 rounded-full border border-border bg-background text-sm">Gallery</span>
                     <span className="px-4 py-1.5 rounded-full border border-border bg-background text-sm">Contact</span>
                     <span className="px-4 py-1.5 rounded-full border border-border bg-background text-sm">Booking Links</span>
                   </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-24 bg-secondary/30 border-y border-border">
          <div className="mx-auto max-w-7xl px-6 sm:px-12">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="font-display text-3xl font-bold mb-8">"We had Instagram, WhatsApp and a PDF catalogue. OWNA gave our customers one place to understand what we actually do."</h2>
        ...
        <section className="py-32" id="explore">
          <div className="mx-auto max-w-7xl px-6 sm:px-12 text-center">
            <h2 className="font-display text-4xl sm:text-5xl font-bold mb-16 tracking-tight">The internet is full of people worth discovering.</h2>
            ...
            <Button size="lg" variant="outline" className="h-14 rounded-full px-8 text-lg font-medium border-border">
        ...
        <section className="py-40 bg-foreground text-background text-center">
          <div className="mx-auto max-w-4xl px-6 sm:px-12">
            <h2 className="font-display text-[64px] sm:text-[88px] font-bold leading-[1.05] tracking-tight mb-8">
              Own your corner<br />of the internet.
            </h2>
            <p className="text-xl sm:text-2xl text-background/70 mb-12">
              Build a presence that's unmistakably yours.
            </p>
            <Button size="lg" className="h-14 rounded-full px-10 text-xl font-medium bg-primary text-primary-foreground hover:bg-primary/90" render={<Link href="/signup" />}>
              Create your OWNA
            </Button>
          </div>
        </section>
